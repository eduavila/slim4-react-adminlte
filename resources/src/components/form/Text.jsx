  ...
  return (
    <div className={`form-group ${toCssClasse(props.cols || `12`)} has-feedback ${touched[field.name] && errors[field.name] ? "has-error" : ""}`}>
      <label className="control-label">
        ...
        { props.helpDescription && <i className="fa fa-question-circle" aria-hidden="true"></i> }
      </label>

      <input type="text" {...field} {...props} className={`form-control ${touched[field.name] && errors[field.name] ? "is-invalid" : ""}`} />
